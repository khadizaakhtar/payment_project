        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="main-content">
                    ...
                    <form action="<?php echo BASE_URL; ?>user_controller/update_register" method="post">
                            ...
                            <div class="form-group full-width">
                                ...
                                <input type="email" name="email" id="email" class="form-control" value="<?php echo $v_result['email'] ?>"/>          <div style="color:red; text-align: center">
                    <?php
                    ...
                    ?>
                            ...
                            <div class="form-group full-width">
                                <label for="tenantName" class="label-1">Email:<span class="error" style="color:red">*</span></label>
                                <input type="email" name="sec_email" id="sec_email" class="form-control" value="<?php echo $v_result['sec_email'] ?>"/>
                            </div>
                             <div class="form-group full-width">
