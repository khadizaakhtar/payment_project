    ...
    <div class="span12">
        ...
        <div class="widget green">
          ...
          // print_r($data);die();
                ...
                ?>
                <!-- BEGIN FORM-->
                <form name="admin_edit_member" action="<?php echo BASE_URL; ?>admin_controller/update_member/<?php echo $data['userid']; ?>" class="form-horizontal" method="post">
...
<script>
    document.forms['admin_edit_member'].elements['turnover_year'].value = "<?php echo  $data['turnover_year']; ?>";
</script>
