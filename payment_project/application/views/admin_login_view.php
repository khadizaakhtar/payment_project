...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
 ...
 <span style="color: #ff0000; text-align: center;font-size: 25px">
                    <?php
            ...
            <form action="<?php echo BASE_URL; ?>admin_login_controller/admin_login_check" method="post">
            ...
            <div class="login-footer">
                ...
                <div class="forgot-hint pull-right">
                    <a id="forget-password" class="" href="<?php echo BASE_URL; ?>admin_login_controller/view_email">Forgot Password?</a>
                </div>
            </div>
        </div>
